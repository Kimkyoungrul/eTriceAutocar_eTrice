...
void nodeRef1_subSystem_destroy(void){
	...
	ATcpClient_dtor(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_0_tcpClient);
	ATcpClient_dtor(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_1_tcpClient);
...
static void nodeRef1_subSystem_constructActorInstances(void){
	...
	ATcpClient_ctor(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_0_tcpClient);
	ATcpClient_ctor(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_1_tcpClient);
...
static void nodeRef1_subSystem_initActorInstances(void){
	...
	HierarchicalReplication_init(&_TrafficLight_subSystem_step4_HierarchicalReplication);
	TrafficLightControllerWithInfrastructure_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_0);
	PedestrianTrafficLightController_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_0_controller);
	TrafficLightInterface_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_0_tlInterface);
	ATcpClient_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_0_tcpClient);
	TrafficLightControllerWithInfrastructure_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_1);
	PedestrianTrafficLightController_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_1_controller);
	TrafficLightInterface_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_1_tlInterface);
	ATcpClient_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_controllerWithInfrastructure_1_tcpClient);
	TrafficLightHeadquarters_init(&_TrafficLight_subSystem_step4_HierarchicalReplication_headquarters2);
