 ...
 */
typedef int32 etCpunum; //etCpunum added by kkr
//typedef LARGE_INTEGER etStarttime; //etCpunum added by kkr
//typedef LARGE_INTEGER etfreq; //etfreq added by kkr
...
typedef struct etThread{
	...
	etCpunum cpunum;         //cpunum added by kkr
//	etStarttime starttime;         //starttime added by kkr
//	etfreq freq;     //freq added by kkr
} etThread;
